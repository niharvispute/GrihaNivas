      ...
      <div className="space-y-8 pb-16">
        {savedProperties.length > 0 ? (
          ...
          <div className="py-20 text-center bg-white rounded-[3rem] border border-dashed border-slate-200">
            ...
            <Link href="/buy" className="bg-primary text-white px-10 py-4 rounded-full font-heading font-black uppercase tracking-widest text-xs shadow-xl shadow-primary/20 hover:bg-primary/90 transition-all inline-block">
              Browse Listings
            </Link>
          </div>
        )}
