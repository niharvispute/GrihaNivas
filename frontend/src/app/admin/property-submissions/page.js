                ...
                <div className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    {[
                      ...
                      { label: 'Commercial Type', value: viewingItem.commercialType },
                      { label: 'Workstations', value: viewingItem.workstations },
                      { label: 'Cabins', value: viewingItem.cabins },
                      { label: 'Car Parking', value: viewingItem.carParking },
                      { label: 'Bike Parking', value: viewingItem.bikeParking },
                      { label: 'Power Backup (KVA)', value: viewingItem.powerBackupKva },
                      { label: 'Commercial Tax Status', value: viewingItem.commercialTaxStatus },
                      { label: 'OC Status', value: viewingItem.ocStatus },
                      { label: 'City', value: viewingItem.city },
                      { label: 'Locality', value: viewingItem.locality },
                      { label: 'Pincode', value: viewingItem.pincode },
                      { label: 'Nearby Landmarks', value: viewingItem.landmarks, full: true },
