              ...
              {loadingPropertyDetail ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                  {[
                    ...
                    { label: 'Commercial Type', value: viewingProperty.commercialType },
                    { label: 'Workstations', value: viewingProperty.workstations },
                    { label: 'Cabins', value: viewingProperty.cabins },
                    { label: 'Car Parking', value: viewingProperty.carParking },
                    { label: 'Bike Parking', value: viewingProperty.bikeParking },
                    { label: 'Power Backup (KVA)', value: viewingProperty.powerBackupKva },
                    { label: 'Commercial Tax Status', value: viewingProperty.commercialTaxStatus },
                    { label: 'OC Status', value: viewingProperty.ocStatus },
                    ...
                    { label: 'Pincode', value: viewingProperty.location?.pincode },
                    { label: 'Nearby Landmarks', value: viewingProperty.location?.landmarks, full: true },
