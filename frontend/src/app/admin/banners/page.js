  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="bg-slate-900 p-12 rounded-2xl text-white relative overflow-hidden group">
          ...
          <div className="flex items-start gap-8 relative z-10">
            <div className="bg-white/10 p-4 rounded-2xl backdrop-blur-md text-primary">
            ...
            <div>
              ...
              <p className="text-slate-400 font-bold leading-[1.8] text-lg">
        ...
        <div className="bg-white p-12 rounded-2xl border border-slate-100 shadow-2xl shadow-slate-200/50 flex items-start gap-8 group">
