        ...
        <section className="py-16 md:py-32 max-w-4xl mx-auto px-6 md:px-8">
          ...
          <div className="space-y-3 md:space-y-4">
            {[
              ...
              { q: "What is the stamp duty impact on my total purchase cost?", a: "In Mumbai, stamp duty is 6% for male buyers, 5% for female buyers, and 5% for joint (male+female) purchases, calculated on the higher of agreement value or Ready Reckoner Rate. Registration charge is a flat ₹30,000. This is separate from your loan amount and must be paid upfront." }
            ].map((faq, i) => (
