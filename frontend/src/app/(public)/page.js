    ...
    <div className="w-full">
      ...
      <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl pt-20">
          ...
          <div className="bg-white/80 backdrop-blur-xl p-2 rounded-[2.5rem] shadow-2xl max-w-4xl mx-auto border border-white/50">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-2">
              <div className="flex flex-col items-start px-6 py-3 text-left">
                ...
                <input className="w-full bg-transparent border-none p-0 text-slate-900 focus:ring-0 font-bold placeholder:text-slate-400" placeholder="Maharashtra" value="Maharashtra" readOnly />
              </div>
              <div className="flex flex-col items-start px-6 py-3 text-left md:border-l border-slate-200">
                ...
                <input className="w-full bg-transparent border-none p-0 text-slate-900 focus:ring-0 font-bold placeholder:text-slate-400" placeholder="Bandra, Juhu..." />
              </div>
              <div className="flex flex-col items-start px-6 py-3 text-left md:border-l border-slate-200">
                <span className="text-[10px] font-black text-primary uppercase tracking-widest mb-1">Property Type</span>
                <select className="w-full bg-transparent border-none p-0 text-slate-900 focus:ring-0 font-bold cursor-pointer">
              ...
              <button className="bg-primary text-white py-4 px-8 rounded-full font-black flex items-center justify-center gap-2 hover:bg-primary/90 transition-all active:scale-95 shadow-lg shadow-primary/20">
