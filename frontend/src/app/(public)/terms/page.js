            ...
            <div className="lg:col-span-8 space-y-16">
              ...
              <article>
                ...
                <p className="text-slate-500 font-bold leading-relaxed">
                  By accessing and using GrihaNivas (the "Platform"), you acknowledge that you have read, understood, and agreed to be bound by these Terms of Use. If you do not agree to these terms, please refrain from using our digital concierge services.
                </p>
              </article>
              ...
              <article className="p-8 rounded-2xl bg-slate-50 border border-slate-100">
                ...
                <p className="text-slate-600 font-bold leading-relaxed mb-6">
                  GrihaNivas provides a curated selection of real estate listings, architectural insights, and advisory services. While we strive for absolute accuracy:
                </p>
              ...
              <article>
                ...
                <p className="text-slate-500 font-bold leading-relaxed">
                  GrihaNivas shall not be liable for any direct, indirect, or consequential damages resulting from your use of the platform, including but not limited to financial losses during property transactions. All transactions are independent contracts between the user and the developer/owner.
                </p>
              </article>
