  ...
  return (
    <main className="max-w-7xl mx-auto px-6 lg:px-8 py-14">
      <section className="grid grid-cols-1 lg:grid-cols-[1.2fr_0.8fr] gap-10 items-start">
        <div className="bg-gradient-to-br from-slate-50 via-white to-slate-100 border border-slate-100 rounded-2xl p-8 md:p-12">
          ...
          <div className="grid sm:grid-cols-3 gap-4 mt-10">
            <div className="bg-white border border-slate-100 rounded-2xl p-4">
              ...
              <p className="text-sm font-bold text-slate-700">Submit your request</p>
            </div>
            <div className="bg-white border border-slate-100 rounded-2xl p-4">
              <p className="text-xs font-black tracking-wide uppercase text-slate-400 mb-2">Step 2</p>
              <p className="text-sm font-bold text-slate-700">Share tenant/owner details</p>
            </div>
            <div className="bg-white border border-slate-100 rounded-2xl p-4">
              <p className="text-xs font-black tracking-wide uppercase text-slate-400 mb-2">Step 3</p>
              <p className="text-sm font-bold text-slate-700">Complete registration</p>
            </div>
          </div>
        </div>
