        ...
        <div className="col-span-2 md:col-span-1">
          ...
          <ul className="space-y-4 text-slate-500">
            ...
            <li className="flex items-center gap-3">
              ...
              <a href="tel:+912245678900" className="hover:text-primary transition-colors">+91 22 4567 8900</a>
            </li>
            <li className="flex items-center gap-3">
              ...
              <a href="mailto:hello@mumbaieditorial.com" className="hover:text-primary transition-colors">hello@mumbaieditorial.com</a>
            </li>
          </ul>
        </div>
      </div>
