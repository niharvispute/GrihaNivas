  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 px-8 text-center bg-white rounded-moderate border border-dashed border-slate-200">
      ...
      {onAction && (
        <button 
          onClick={onAction}
          className="bg-primary text-white px-8 py-3 rounded-full font-bold text-sm shadow-lg shadow-primary/20 hover:bg-primary/90 transition-all active:scale-95"
        >
          {actionLabel}
        </button>
      )}
