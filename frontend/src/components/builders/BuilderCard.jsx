      ...
      <div className="relative h-44 sm:h-48 overflow-hidden bg-zinc-100">
        {thumbnail ? (
          ...
          <div className="w-full h-full bg-linear-to-br from-zinc-100 via-zinc-50 to-white flex items-center justify-center">
            <span className="material-symbols-outlined text-zinc-300 text-4xl">domain</span>
          </div>
        )}
        {builder.tier && (
      ...
      <div className="p-6 flex flex-col grow">
        <div className="flex items-start justify-between mb-4">
          <div className="w-12 h-12 bg-zinc-50 rounded-lg p-1.5 border border-zinc-100 shadow-sm flex items-center justify-center">
            {builder.isIconLogo ? (
              <span className="material-symbols-outlined text-primary text-3xl">{logo}</span>
            ) : hasLogo ? (
        ...
        <h3 className="font-headline text-lg sm:text-xl font-bold text-on-background mb-2 group-hover:text-primary transition-colors">
          {builder.name}
        </h3>
        ...
        <div className="mt-auto pt-4 border-t border-zinc-100 flex items-center justify-between text-xs font-medium text-zinc-500 mb-5 sm:mb-6 gap-3">
