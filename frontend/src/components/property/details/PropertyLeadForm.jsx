...
export default function PropertyLeadForm({ property }) {
  ...
  return (
    <section id="lead-form" className="bg-slate-50 p-8 rounded-2xl border border-slate-100 shadow-sm">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <button
          ...
          className="w-full bg-primary text-white py-4 rounded-full font-bold text-base shadow-lg hover:shadow-primary/20 transition-all active:scale-95 mt-4 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        >
          {isSubmitting && (
      ...
      <div className="mt-4">
        <a
          ...
          className="w-full flex items-center justify-center gap-2 border-2 border-[#25D366] text-[#25D366] py-3.5 rounded-full font-bold text-sm hover:bg-[#25D366]/5 transition-all"
        >
