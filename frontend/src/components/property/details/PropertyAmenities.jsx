    ...
    <section>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 gap-2.5 sm:gap-6">
        {amenities.map((item, idx) => (
          <div key={idx} className="p-3 sm:p-6 bg-slate-50 rounded-2xl flex flex-col items-center text-center group hover:bg-white hover:shadow-xl transition-all border border-transparent hover:border-slate-100 italic">
