      ...
      <div className="space-y-4">
        {brochureUrl ? (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="w-full bg-primary text-white py-4 rounded-full font-black text-lg hover:bg-primary/90 transition-all flex items-center justify-center gap-2 shadow-lg"
          >
