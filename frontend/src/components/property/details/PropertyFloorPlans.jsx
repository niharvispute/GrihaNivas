          ...
          <div className="absolute inset-0 bg-slate-900/45 backdrop-blur-md px-4 sm:px-6 py-6 sm:py-8">
            ...
            {brochureUrl ? (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full justify-center bg-primary text-white px-4 sm:px-8 py-2.5 sm:py-3 rounded-full font-bold text-xs sm:text-base flex items-center gap-2 hover:scale-105 transition-transform shadow-lg"
              >
