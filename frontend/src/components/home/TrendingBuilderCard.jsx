    ...
    <article className="group relative bg-white rounded-2xl overflow-hidden border border-slate-200 hover:border-primary/25 shadow-sm hover:shadow-lg hover:shadow-slate-200/80 transition-all duration-500 flex flex-col h-full">
      ...
      <div className="p-3 sm:p-4 md:p-5 flex flex-col grow gap-2 sm:gap-3 min-h-[190px]">
        ...
        <div className="grid grid-cols-2 gap-3 py-2 sm:py-3 border-t border-slate-100">
          <div>
            <p className="text-[9px] sm:text-[10px] uppercase font-bold text-slate-400 tracking-wider">Est.</p>
            <p className="text-xs sm:text-sm font-black text-slate-900 mt-1">{established}</p>
          </div>
          <div className="border-l border-slate-100 pl-3">
            <p className="text-[9px] sm:text-[10px] uppercase font-bold text-slate-400 tracking-wider">Projects</p>
        ...
        <Link
          href={detailHref}
          className="mt-auto h-9 sm:h-10 flex items-center justify-center bg-gradient-to-r from-primary to-primary/85 text-white rounded-lg font-black text-[10px] sm:text-xs uppercase tracking-tighter hover:shadow-lg hover:shadow-primary/40 transition-all"
        >
          View Builder
        </Link>
      </div>
