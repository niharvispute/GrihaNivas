  ...
  return (
    <article className="group rounded-2xl overflow-hidden">
      ...
      <div className="flex items-center gap-1.5 mb-2">
        {property?.isVerified && (
          <span className="inline-flex items-center gap-1 rounded-full border border-slate-200 bg-white px-2 py-1 text-[11px] font-bold text-slate-700">
      ...
      <h3 className="text-xl leading-tight font-black text-slate-900 tracking-[-0.01em] mb-1 line-clamp-1">
        {projectTitle}
      </h3>
      <p className="text-base text-slate-700 mb-0.5 line-clamp-1">
        {configurationLabel}
      </p>
      <p className="text-base text-slate-800 font-bold mb-3.5 line-clamp-1">{locationLabel}</p>
