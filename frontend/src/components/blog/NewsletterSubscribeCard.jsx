...
export default function NewsletterSubscribeCard() {
  ...
  return (
    <div className="bg-primary p-6 sm:p-7 lg:p-9 rounded-4xl sm:rounded-5xl lg:rounded-[3rem] text-white shadow-2xl shadow-primary/40 relative overflow-hidden group">
      ...
      <h4 className="text-xl sm:text-2xl font-black mb-3 tracking-tighter leading-none uppercase italic">Subscribe for <br /> Insights</h4>
      <p className="text-white/70 text-[11px] sm:text-xs mb-6 sm:mb-7 leading-relaxed font-bold">Join 5,000+ investors receiving our weekly analysis.</p>
