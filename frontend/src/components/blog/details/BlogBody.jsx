  ...
  return (
    <article className="lg:col-span-8">
      ...
      <div className="max-w-none text-slate-600 leading-[1.8] font-medium text-base sm:text-lg font-sans">
        ...
        <div 
          className="prose prose-sm sm:prose-base lg:prose-lg prose-slate max-w-none prose-headings:font-black prose-headings:tracking-tighter prose-headings:text-slate-900 prose-p:mb-6 sm:prose-p:mb-8 prose-strong:text-slate-900"
        ...
        {!post.content && (
          <>
            ...
            <h3 className="text-2xl sm:text-3xl font-black text-slate-900 mb-5 sm:mb-6 tracking-tighter" id="sobo">The Strategic Appeal of SoBo</h3>
            <p className="mb-8 sm:mb-10">
            ...
            <div className="bg-primary/5 rounded-3xl p-5 sm:p-6 lg:p-8 mb-8 sm:mb-10 lg:mb-12 border border-primary/10 flex items-start gap-4 sm:gap-6 relative overflow-hidden group">
              ...
              <div>
                ...
                <p className="text-slate-900 font-black text-base sm:text-lg leading-relaxed">Properties in Worli are seeing a 15% YoY appreciation, outperforming the general Mumbai average.</p>
              </div>
            </div>

            <p className="mb-10 sm:mb-14 lg:mb-16">
        ...
        {/* Tags */}
        <div className="flex flex-wrap gap-2 sm:gap-3 mt-10 sm:mt-12 lg:mt-16 border-t border-slate-100 pt-8 sm:pt-10">
          {['South Mumbai', 'Luxury Real Estate', 'Investment', 'Penthouse Market'].map(tag => (
            <span key={tag} className="px-4 sm:px-5 py-2 bg-slate-50 border border-slate-100 rounded-full text-[9px] sm:text-[10px] font-black uppercase tracking-widest text-slate-400 hover:text-primary hover:border-primary/20 transition-all cursor-pointer">
              {tag}
            </span>
          ))}
        </div>
