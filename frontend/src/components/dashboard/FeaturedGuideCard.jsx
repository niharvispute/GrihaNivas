...
export default function FeaturedGuideCard() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-slate-900 group aspect-[16/9] sm:aspect-[4/3] lg:aspect-[4/3]">
      <Image
        fill
        ...
        alt="Featured Guide"
      />
      <div className="absolute inset-0 bg-gradient-to-t from-slate-900 via-slate-900/20 to-transparent p-4 sm:p-5 flex flex-col justify-end">
        <span className="bg-primary text-white text-[8px] sm:text-[9px] font-black uppercase tracking-[0.2em] px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full w-fit mb-1.5 sm:mb-2">
          Featured Guide
        </span>
