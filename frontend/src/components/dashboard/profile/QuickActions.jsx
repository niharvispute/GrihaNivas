    ...
    <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 mt-6 sm:mt-8">
      {actions.map((action) => (
        <Link
          key={action.label}
          href={action.href}
          className="relative overflow-hidden rounded-2xl p-3 sm:p-6 md:p-8 shadow-sm transition-all duration-500 hover:shadow-lg hover:shadow-slate-200/80 hover:-translate-y-1 border border-slate-100 bg-white group cursor-pointer"
        >
