      ...
      <div className="flex flex-col md:flex-row items-center gap-6 sm:gap-8">
        ...
        <div className="text-center md:text-left flex-1 min-w-0">
          <div className="flex flex-col md:flex-row md:items-center gap-2 sm:gap-3 mb-2">
            <h2 className="text-2xl sm:text-3xl font-heading font-black text-slate-900 tracking-tight truncate">{name}</h2>
            {isVerified && (
              <span className="bg-emerald-50 text-emerald-600 px-2 sm:px-3 py-1 rounded-full text-[8px] sm:text-[10px] font-black uppercase tracking-widest w-fit mx-auto md:mx-0 flex items-center gap-1 border border-emerald-100 flex-none">
          ...
          <div className="flex flex-wrap justify-center md:justify-start items-center gap-2 sm:gap-4 text-slate-400 text-[9px] sm:text-xs font-bold uppercase tracking-wider">
            {joinedDate && (
