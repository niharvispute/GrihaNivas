...
const schemas = {
  ...
  project: {
    ...
    create: z.object({
      ...
      projectType: z.enum(['residential', 'commercial', 'mixed', 'plotting']).default('residential'),
      ...
      maintenanceCharges: z.string().trim().max(200).optional(),
      reraVerified:  stringBooleanSchema.optional(),
      enablePriceRequest:     stringBooleanSchema.optional(),
      enableCallback:         stringBooleanSchema.optional(),
